        ...
        <div class="row">
            <div class="col-md-5 pt-3 pb-3 bg-secondary">
                ...
                <table  style="width: 100%;">
                    <tr>
                        <td>Origin</td>
                        <td style="color: #000000;">{{ $PickupBranch->city.', '.$PickupBranch->country}} </td>
                    </tr>
                    <tr>
                        <td>Destination</td>
                        <td style="color: #000000;">{{ $ProcessedBranch->city.', '.$ProcessedBranch->country}} </td>
                    </tr>
                    <tr>
                        <td>Booking Date</td>
                        <td style="color: #000000;">{{ \Carbon\Carbon::parse($ParcelDetails->created_at)->format('M d, Y') }}</td>
            ...
            <div class="col-md-5 pt-3 pb-3 bg-secondary ml-auto mt-5 mt-md-0">
                ...
                <p class="text-muted">
                    ...
                    <span class="font-weight-bold ml-3" style="color: #00611f;">
                        {{ $ParcelDetails->status->ParcelStatus}}
                    </span>
                </p>
