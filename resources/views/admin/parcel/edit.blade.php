...
<head>
  ...
  <title> DMSGP | Update Parcel </title>
    ...
    <div class="content-wrapper mt-5 pt-2">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- /.col -->
                    <div class="col-md-12">
                        <form id="AddParcelForm" method="POST" action="{{route('UpdateParcel', $parcel->id)}}" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="SenderName" value="{{ old('SenderName', $parcel->SenderName) }}" class="form-control form-control-sm" placeholder="@lang('parcel.Parcel sender name')">
                                        ...
                                        <div class="col-md-6 ml-0 ml-md-5">
                                            <div class="form-group pl-0 pl-md-5">
                                                ...
                                                <input type="text" name="SenderContact" value="{{ old('SenderContact', $parcel->SenderContact) }}" class="form-control form-control-sm" placeholder="@lang('parcel.Parcel sender contact number')">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-5 form-group">
                                            <label> @lang('parcel.Name') </label>
                                            <input type="text" name="RecieverName" value="{{ old('RecieverName', $parcel->RecieverName) }}" class="form-control form-control-sm" placeholder="@lang('parcel.Parcel receiver name')">
                                        ...
                                        <div class="col-md-6 ml-0 ml-md-5">
                                            <div class="form-group pl-0 pl-md-5">
                                                ...
                                                <input type="text" name="RecieverAddress" value="{{ old('RecieverAddress', $parcel->RecieverAddress) }}" class="form-control form-control-sm" placeholder="@lang('parcel.Parcel receiver address')">
                                        ...
                                        <div class="col-md-5 form-group">
                                            <label for> @lang('parcel.Contact') </label>
                                            <input type="text" name="RecieverContact" value="{{ old('RecieverContact', $parcel->RecieverContact) }}" id="RecieverContact" value="{{ old('RecieverContact') }}" class="form-control form-control-sm" placeholder="@lang('parcel.Parcel receiver contact number')" required>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="PickupBranch" id="PickupBranch" class="form-control form-control-sm input-sm" required>
                                                    <option value="{{$PickupBranch->id ?? 'Null'}}">{{ $PickupBranch->name.' | '.$PickupBranch->city.' | '.$PickupBranch->ZipCode.' | '.$PickupBranch->state.' | '.$PickupBranch->country ?? 'Null'}}</option>
                                        ...
                                        <div class="col-md-6 ml-0 ml-md-5">
                                            <div class="form-group pl-0 pl-md-5">
                                                ...
                                                <select name="ProcessedBranch" id="ProcessedBranch" class="form-control form-control-sm input-sm">
                                                    <option value="{{$ProcessedBranch->id ?? 'Null'}}">{{ $ProcessedBranch->name.' | '.$ProcessedBranch->city.' | '.$ProcessedBranch->ZipCode.' | '.$ProcessedBranch->state.' | '.$ProcessedBranch->country ?? 'Null'}}</option>
                                                    @foreach ($branches as $branch)
                                                    ...
                                                    <div class="d-flex form-group">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" name="PaymentStatus" class="form-check-input" value="Paid" {{ (old('PaymentStatus') == 'Paid' || $parcel->PaymentStatus == 'Paid') ? 'checked' : '' }}> @lang('parcel.Paid')
                                                            </label>
                                                        </div>
        
                                                        <div class="form-check ml-3">
                                                            <label class="form-check-label">
                                                                <input type="radio" name="PaymentStatus" class="form-check-input" value="COD" {{ (old('PaymentStatus') == 'COD' || $parcel->PaymentStatus == 'COD') ? 'checked' : '' }}> @lang('parcel.Unpaid')
                                                            </label>
                                                        </div>
                                                    </div>
                            ...
                            <div class="form-group row mt-5">
                                <div class=" col-4 col-sm-2 ml-auto mr-auto">
                                    <button type="submit" class="btn btn-primary"> @lang('parcel.Update') </button>
                                </div>
                            </div>
    ...
    <div style="display: flex; justify-content: space-between; width: 100%; margin-left: 20px;">
        ...
        <div style="width: 66%; border: 1px solid black;">    
            <div style="display: flex; justify-content: space-between;">
                ...
                <p style="font-size: 30px; margin-top: 15px;">ဒို့မြန်မာ</p>

                <div style="margin: 15px 10px 0 0; border-right: 0.2px solid black;">
